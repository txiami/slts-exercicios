...
public class Program {
	...
	public static void main(String[] args) {
		...
		System.out.println("Digite o número do dia do seu aniverário:");
		int dia = sc.nextInt();
		System.out.println("Digite o número do mês do seu aniverário:");
		int mes = sc.nextInt();
		...
		LocalDate dataNascimento = LocalDate.of(anoNasc, mes, dia);
        LocalDate anoHj = LocalDate.now();
        int idade = calcularIdade(dataNascimento, anoHj);
	...
	public static int calcularIdade(LocalDate dataNascimento, LocalDate anoHj) {
        Period periodo = Period.between(dataNascimento, anoHj);
